...
import { Search, Filter, X, ChevronLeft, ChevronRight, FileText, Calendar, Eye } from 'lucide-react';
...
const SearchPage: React.FC = () => {
  ...
  const performSearch = useCallback(async () => {
    ...
    // 统一使用 fetchDocuments 进行搜索，确保筛选条件一致
    ...
    setLoading(false);
  }, [keyword, selectedCategory, currentPage, sortBy, fetchDocuments]);
      ...
      <main className="flex-1 bg-gray-50">
        ...
        <div className="bg-white border-b border-gray-200">
          <div className="container mx-auto px-4 py-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-4">法律法规检索</h1>
            ...
            {showFilters && (
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="text-sm text-gray-600 mb-1 block">排序方式</label>
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          {!loading && results && (
            <div className="mb-6 text-gray-600">
              共找到 <span className="font-semibold text-red-700">{results.total}</span> 条结果
